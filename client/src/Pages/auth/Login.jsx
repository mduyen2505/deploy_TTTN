...
const LoginPage = () => {
  ...
  const handleGoogleLogin = () => {
    window.location.href =
      "https://deploytttn-production.up.railway.app/api/users/auth/google";
  };
    ...
    <div className="login-page">
      <div className="login-auth-container">
          ...
          {!showResetPasswordForm ? (
            <form className="login-sign-in-form" onSubmit={handleSubmit}>
              ...
              <div className="login-social-media">
                <a href="https://facebook.com" className="login-social-icon">
                ...
                <a href="https://twitter.com" className="login-social-icon">
                  <FontAwesomeIcon icon={faTwitter} />
                </a>
                <a href="https://linkedin.com" className="login-social-icon">
        ...
        <div className="login-welcome-container">
          ...
          <Link to="/signup" className="login-btn login-register-btn">
            Register
          </Link>
        </div>
      </div>
